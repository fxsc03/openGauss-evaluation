...
//         //     CPU_ZERO(&cpuset);
//         //     for (int i = 0; i <= 23; i++) {
//         //         CPU_SET(i, &cpuset);        // NUMA 0 物理核心: 24
//         //     }
//         //     for (int i = 96; i <= 119; i++) {
//         //         CPU_SET(i, &cpuset);        // NUMA 0 物理核心: 24
//         //     }
//         //     for (int i = 24; i <= 39; i++) {
//         //         CPU_SET(i, &cpuset);        // NUMA 1 物理核心: 16
//         //     }
...
//         //     CPU_ZERO(&cpuset);
//         //     for (int i = 40; i <= 47; i++) {
//         //         CPU_SET(i, &cpuset);        // NUMA 1 物理核心: 8
//         //     }
//         //     for (int i = 120; i <= 143; i++) {
//         //         CPU_SET(i, &cpuset);        // NUMA 1 物理核心: 24
//         //     }
//         //     for (int i = 48; i <= 71; i++) {
//         //         CPU_SET(i, &cpuset);        // NUMA 2 物理核心: 24
//         //     }
//         //     for (int i = 72; i <= 79; i++) {
//         //         CPU_SET(i, &cpuset);        // NUMA 2 物理核心: 8
//         //     }
//         //     sched_setaffinity(0, sizeof(cpu_set_t), &cpuset);
//         // }else if(key ==5){
//         //     cpu_set_t cpuset;
...
//         //     elog(LOG,"node 12 on numa : %d",numa_node);
//         // }else if(planNodeId +1 == 15){
//         //     elog(LOG,"node 15 on numa : %d",numa_node);
//         // }   
...
//      */
//     start_xact_command();
//     // elog(LOG,"PARENT ID %d\n",producer->getParentPlanNodeId());
