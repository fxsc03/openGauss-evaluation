...
{
	"blob_offset_overflow", ERRCODE_BLOB_OFFSET_OVERFLOW
},
...
{
	"invalid_condition_number", ERRCODE_INVALID_CONDITION_NUMBER
},
...
{
	"create_subtype_under_final", ERRCODE_CREATE_SUBTYPE_UNDER_FINAL
},

{
	"parameter_error_for_map", ERRCODE_MAP_METHOD_PARAMETER
},

{
	"An_object_type_can_have_only_1_MAP_OR_ORDER_method", ERRCODE_OBJECT_ONLY_ONE_MAP_OR_ORDER_METHOD
},

{
	"object_type_method_define_error", ERRCODE_OBJECT_TYPE_METHOD_DEFINE_ERROR
},

{
	"object_type_body_define_error", ERRCODE_OBJECT_TYPE_BODY_DEFINE_ERROR
},

{
	"a_static_method_cannot_declare_parameter_self", ERRCODE_OBJECT_TYPE_STATIC_ERROR
},
...
{
	"undefined_package", ERRCODE_UNDEFINED_PACKAGE
},
...
{
	"duplicate_package", ERRCODE_DUPLICATE_PACKAGE
},
...
{
	"invalid_temp_objects", ERRCODE_INVALID_TEMP_OBJECTS
},

{
	"invalid_package_definition", ERRCODE_INVALID_PACKAGE_DEFINITION
},
...
{
	"rbin_lock_not_available", ERRCODE_RBIN_LOCK_NOT_AVAILABLE
},

{
	"rbin_undefined_object", ERRCODE_RBIN_UNDEFINED_OBJECT
},
...
{
	"fdw_invalid_option_data", ERRCODE_FDW_INVALID_OPTION_DATA
},
...
{
	"fdw_too_many_ddl_statements_in_transaction", ERRCODE_FDW_TOO_MANY_DDL_CHANGES_IN_TRANSACTION
},

{
	"fdw_drop_indexed_column_not_allowed", ERRCODE_FDW_DROP_INDEXED_COLUMN_NOT_ALLOWED
},
...
{
	"cannot_modify_xidbase", ERRCODE_CANNOT_MODIFY_XIDBASE
},
...
{
	"pldebugger_wait_timeout", ERRCODE_PLDEBUGGER_TIMEOUT
},

{
	"forall_dml_error", ERRCODE_FORALL_DML_ERROR
},
...
{
	"duplicate_policy", ERRCODE_DUPLICATE_POLICY
},

{
	"duplicate_label", ERRCODE_DUPLICATE_LABEL
},

{
	"invalid_audit_log", ERRCODE_INVALID_AUDIT_LOG
},

{
	"recovery_conflict", ERRCODE_SR_RECOVERY_CONFLICT
},

{
	"gms_tcp_end_of_input", ERRCODE_END_OF_INPUT
},

{
	"gms_tcp_network_error", ERRCODE_NETWORK_ERROR
},

{
	"gms_tcp_bad_argument", ERRCODE_BAD_ARGUMENT
},

{
	"gms_tcp_transfer_timeout", ERRCODE_TRANSFER_TIMEOUT
},

{
	"gms_tcp_partial_multibyte_char", ERRCODE_PARTIAL_MULTIBYTE_CHAR
},

{
	"gms_tcp_buffer_too_small", ERRCODE_BUFFER_TOO_SMALL
},
